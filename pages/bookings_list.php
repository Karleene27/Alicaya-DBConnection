...
<div class="container">
    <h2>Bookings</h2>
    <p><a href="bookings_create.php" class="btn">+ Create Booking</a></p>
        ...
        <table class="table">
            ...
            <?php while($b = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <td class="actions">
                        <a href="payment_process.php?booking_id=<?php echo $b['booking_id']; ?>" class="btn-small">Process Payment</a>
                    </td>
                </tr>
            <?php } ?>
        </table>
